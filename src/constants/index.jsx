export const features = [
  {
    ...
    text: "With NoltixAI, tedious tasks are history. Automation and smart processes bring your productivity to new heights. It's like having an extra cup of coffee, but without the jitters.",
    button: {
  ...
  },
  {
    ...
    caption: "Customized AI agents",
    title: "Send email, create calender event, create sales pitch from voice message, create SEO content, and many more customized workflow automations",
    button: {
...
export const details = [
  {
    ...
    title: "AI automated office workflows",
  },
  {
    id: "1",
...
export const faq = [
  ...
  },
  {
    ...
    answer:
      "Click on any one of the 'Get Started' buttons, download the sample json workflow to experience on n8n platform to get a feel, or email info@noltixtech.com to know more.",
  },
...
export const plans = [
  {
    ...
    priceMonthly: 19,
    priceYearly: 12,
    caption: "Best for single person",
    features: [
      "3 workflows",
...
export const testimonials = [
  {
    ...
    comment:
      "Noltix's customer support is second to none! They’re like my tech superheroes, always there when I need them.",
  },
  {
    id: "1",
    name: "Mark Erixon",
    ...
    comment:
      "I was skeptical at first, but now I can't imagine our SEO operations without it. It's that impactful.",
  },
  {
    id: "2",
    name: "Melanie Hurst",
  ...
  },
  {
    ...
    comment:
      "The tool is like having a personal assistant. It's been instrumental in guiding our business decisions.",
  },
  {
    id: "4",
    name: "Becky Snider",
    ...
    comment:
      "Switched to NoltixAI last month, and I'm already seeing results. Best decision for our team!",
  },
  {
    id: "5",
    name: "Jim Bradley",
